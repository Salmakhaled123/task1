...
class UpdateUserDetailsView extends StatelessWidget {
  UpdateUserDetailsView({Key? key, required this.model}) : super(key: key);
                          ...
                          child: ElevatedButton(
                              onPressed: () {
                                if (key.currentState!.validate()) {
                                  // int x= int.parse(passController.text);
                                  cubit.updateUserDetails(AllUserModel(
                                    name: nameController.text,
                                    userStatus: '0',
                                    id: model.id,
                                    email: emailController.text,
                                    phone: phoneController.text,
                                    userType: types.toString(),
                                  ),context);
                                  print(model.id);
                                }
                              },
